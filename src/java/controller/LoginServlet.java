...
public class LoginServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>"+email+" Thank you for Login with password: "+password+"</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
      ...
      Signup loginUser = dao.findSignupByEmailAndPassword(signup.getEmail(), signup.getPassword());
if(loginUser != null){
    // Create a session
